...
namespace DoctorEverywhere.Migrations
{
    ...
    [Migration("20260507204619_RemoveDoctorOfficeIdAndEndTimeAppointment")]
    partial class RemoveDoctorOfficeIdAndEndTimeAppointment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Appointment", b =>
                {
                    b.HasOne("DoctorEverywhere.Domain.Doctor", "Doctor")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DoctorEverywhere.Domain.Patient", "Patient")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Doctor", b =>
                {
                    b.HasOne("ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("DoctorEverywhere.Domain.Doctor", "ApplicationUserId")
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Manager", b =>
                {
                    b.HasOne("ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("DoctorEverywhere.Domain.Manager", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Message", b =>
                {
                    b.HasOne("DoctorEverywhere.Domain.Appointment", "Appointment")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Office", b =>
                {
                    b.HasOne("DoctorEverywhere.Domain.Doctor", "Doctor")
                        .WithOne("Office")
                        .HasForeignKey("DoctorEverywhere.Domain.Office", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DoctorEverywhere.Domain.Patient", b =>
                {
                    b.HasOne("ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("DoctorEverywhere.Domain.Patient", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
